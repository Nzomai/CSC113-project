...
/// write file:
	...
	public void readHotel (String fileName)throws ClassNotFoundException , IOException {
			...
			hName = (String) obj.readObject();
			LisOfReservations = (Reservation [])obj.readObject();
			LisOfRooms = (Room [])obj.readObject();
            obj.close();	
		}
